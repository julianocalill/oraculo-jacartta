...
- `docs/glossario-cards-dashboard.md` — cada card/coluna/config de TODO o
  sistema (análise + operacional: alertas, calculadora, importações,
  parâmetros, status, usuários), fórmula exata e limiares.
