...
não recebe Partner Key e não armazena tokens. A Shopee devolve somente `code` e
`shop_id` na query; por isso o state assinado e temporário viaja no caminho do
webhook.
