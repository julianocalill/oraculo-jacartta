...
- A conta Giracasa usará o aplicativo Olist/Tiny Token API (V2). Secret `GIRACASA_OLIST_API_V2_TOKEN`, chamadas `POST` para `https://api.tiny.com.br/api2/` e prova de identidade por `info.php`; o conector V3 de Uberlândia permanece inalterado.
