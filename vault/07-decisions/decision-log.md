...
- 2026-07-16: Custos unitários ancorados no SKU do marketplace (view `oraculo_sku_unit_cost`): override manual em /shopee/reposicao ou /parametros (prioridade) > olist_products (custos zerados no ERP ficam de fora) > custo efetivo de kits. Motivo: o ERP tem custo R$ 0 para a maioria dos SKUs; o marketplace (Shopee) tem a disciplina de SKU (98%), então o livro de custos vive ancorado nele.
