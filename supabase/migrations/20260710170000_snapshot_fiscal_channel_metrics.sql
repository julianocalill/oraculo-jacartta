-- oraculo_fiscal_channel_metrics também é calculada on-the-fly e excede o
-- statement_timeout do role authenticated no mês corrente (57014 -> 500 no
-- dashboard). Materializa no mesmo snapshot noturno (chave fiscal_channel_metrics).
