-- A lista operacional passa a incluir qualquer SKU que forme ao menos uma
-- caixa completa. A regra vale para o documento persistido; n8n, CSV e
-- WhatsApp usam o mesmo limite no código do workflow.
...
comment on table public.logistica_picking_itens is
  'Linhas congeladas da lista de separacao, filtradas para o minimo operacional de uma caixa completa.';

comment on function public.logistica_picking_finalize(uuid, jsonb, boolean) is
  'Persiste o relatorio com SKUs de uma caixa completa ou mais e, quando oficial, avanca o cursor no mesmo commit.';
